        ...
        return new Promise(function (resolve) {
            ...
            request.onload = function () {
                ...
                if(isNullOrEmpty(response)) {
                    MintyConsole.Error("Discord API response was null.");
                    resolve(undefined);
                    return;
                }
                ...
                if(isNullOrEmpty(data)) {
                    MintyConsole.Debug("Discord data about profile was null.", false);
                    resolve(undefined);
                    return;
                }
                ...
                MintyConsole.Debug(`Discord hooked data successfully`, true);
            }
